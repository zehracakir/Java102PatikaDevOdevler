        ...
        if (!productList.isEmpty()) {
            for (Product product : productList) {
                ...
                System.out.printf("| %-2s | %-30s| %-10s TL | %-10s| %-10s| %-12s | %-10s | %-10s | %-10s | %-10s |\n" ,
                        product.getId(), product.getName(), product.getPrice(), product.getName(),
                        product.getMemory(), product.getScreenSize(), product.getBattery(), product.getRam(), product.getColor());
            }
            System.out.println("-------------------------------------------------------------------------------------------------------------------------------------------------");
...
public static void addItems(int number) {
   ...
   scanner.nextLine();
    ...
    if (number%2 != 0) {
        ...
        Product newNotebook = new Product(idPhone, idNotebook, price, discountRate, stock, name, brand, memory, screenSize, battery, ram);
       ...
       scanner.nextLine();
        ...
        Product newMobilePhone = new Product(idPhone, idNotebook, price, discountRate, stock, name, brand, memory, screenSize, battery, ram, color);
